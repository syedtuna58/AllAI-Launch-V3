...
import { Mail, Phone, MessageSquare, Globe, AlertCircle, CheckCircle, Clock } from "lucide-react";
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight" data-testid="page-title-inbox">📬 AI Command Center</h1>
